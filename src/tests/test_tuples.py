...
def test_tuples_compute_magnitude4():
    t1 = Tuples(1,2,3,0)
    assert ( t1.equal(t1.magnitude(),sqrt(14)))   
...
def test_tuples_normalizing_vector3():
    ...
    assert (normalized.equal(1, normalized.magnitude()))  
