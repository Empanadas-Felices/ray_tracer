...
def main():
    ...
    new_sphere = Sphere()
    new_sphere.transform = Transformations().translation(0, 0.2, -0.5) * Transformations().scaling(0.25, 0.25, 0.25)
    new_sphere.material = Materials()
    new_sphere.material.color = Colors(0.2, 0.6, 0.92)
    new_sphere.material.diffuse = 0.7
    new_sphere.material.specular = 0.5
    ...
    canvas.canvas_to_ppm("../results/spheres.ppm")
